...
## 参考サイト
  ...
  - [50分でわかるテスト駆動開発](https://channel9.msdn.com/Events/de-code/2017/DO03?ocid=player)

  - [サルでもわかるGit入門〜バージョン管理を使いこなそう〜](https://backlog.com/ja/git-tutorial/)

  - [プログラミング言語 Ruby リファレンスマニュアル](https://docs.ruby-lang.org/ja/)

  - [検索結果を要チェック！Rubyの公式リファレンスは docs.ruby-lang.org です〜公式な情報源を調べるクセを付けよう〜](https://qiita.com/jnchito/items/2dc760ee0716ea12bbf0)
